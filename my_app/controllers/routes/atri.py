...
class Atri:
	def __init__(self, state: Any):
		...
		self.header_detail = state["header_detail"]
		self.header_logo = state["header_logo"]
		self.header_menu = state["header_menu"]
		self.header_button = state["header_button"]
		self.section = state["section"]
		self.section_detail = state["section_detail"]
		self.section_button = state["section_button"]
		self.section_img = state["section_img"]
		self.home = state["home"]
		self.home_container = state["home_container"]
		self.home_content = state["home_content"]
		self.home_button = state["home_button"]
		self.home_img = state["home_img"]
		self.About = state["About"]
		self.about_img = state["about_img"]
		self.about_img_container = state["about_img_container"]
		self.about_detail_container = state["about_detail_container"]
		self.about_detail_container_1 = state["about_detail_container_1"]
		self.about_detail_container_2 = state["about_detail_container_2"]
		self.about_detail_container_3 = state["about_detail_container_3"]
		self.about_container = state["about_container"]
		self.about_button = state["about_button"]
		self.instagram = state["instagram"]
		self.instagram_head = state["instagram_head"]
		self.instagram_content = state["instagram_content"]
		self.instagram_container = state["instagram_container"]
		self.instagram_container_1 = state["instagram_container_1"]
		self.instagram_container_2 = state["instagram_container_2"]
		self.category = state["category"]
		self.category_content = state["category_content"]
		self.Flex30 = state["Flex30"]
		self.Flex31 = state["Flex31"]
		self.Flex32 = state["Flex32"]
		self.Flex33 = state["Flex33"]
		self.category_button = state["category_button"]
		self.footer = state["footer"]
		self.footer_details = state["footer_details"]
		self.footer_stars = state["footer_stars"]
		self.footer_list = state["footer_list"]
		self.footer_list_2 = state["footer_list_2"]
		self.footer_list_1 = state["footer_list_1"]
		self.footer_img = state["footer_img"]
		self.footer_img_1 = state["footer_img_1"]
		self.footer_img_2 = state["footer_img_2"]
		self.Sponsor = state["Sponsor"]
		self.sponsor_img = state["sponsor_img"]
		self.menu = state["menu"]
		self.menu_container = state["menu_container"]
		self.menu_container_1 = state["menu_container_1"]
		self.product_cart_1 = state["product_cart_1"]
		self.Div6 = state["Div6"]
		self.product_cart_2 = state["product_cart_2"]
		self.Div7 = state["Div7"]
		self.product_cart_3 = state["product_cart_3"]
		self.Div8 = state["Div8"]
		self.product_cart_4 = state["product_cart_4"]
		self.Div9 = state["Div9"]
		self.menu_container_2 = state["menu_container_2"]
		self.product_cart_5 = state["product_cart_5"]
		self.Div10 = state["Div10"]
		self.product_cart_6 = state["product_cart_6"]
		self.Div11 = state["Div11"]
		self.product_cart_7 = state["product_cart_7"]
		self.Div12 = state["Div12"]
		self.product_cart_8 = state["product_cart_8"]
		self.Div13 = state["Div13"]
		self.menu_button = state["menu_button"]
		self.review = state["review"]
		self.review_button = state["review_button"]
		self.review_detail = state["review_detail"]
		self.review_arrow_1 = state["review_arrow_1"]
		self.review_content = state["review_content"]
		self.review_stars = state["review_stars"]
		self.review_img = state["review_img"]
		self.review_img_detail = state["review_img_detail"]
		self.review_arrow_2 = state["review_arrow_2"]
	...
	def header_detail(self):
		self._getter_access_tracker["header_detail"] = {}
		return self._header_detail
	@header_detail.setter
	def header_detail(self, new_state):
		self._setter_access_tracker["header_detail"] = {}
		global default_state
		self._header_detail = Flex(new_state, default_state["header_detail"])

	@property
	def header_logo(self):
		self._getter_access_tracker["header_logo"] = {}
		return self._header_logo
	@header_logo.setter
	def header_logo(self, new_state):
		self._setter_access_tracker["header_logo"] = {}
		global default_state
		self._header_logo = Div(new_state, default_state["header_logo"])
	...
	def header_menu(self, new_state):
		...
		global default_state
		self._header_menu = Flex(new_state, default_state["header_menu"])

	@property
	def header_button(self):
		self._getter_access_tracker["header_button"] = {}
		return self._header_button
	@header_button.setter
	def header_button(self, new_state):
		self._setter_access_tracker["header_button"] = {}
		global default_state
		self._header_button = Flex(new_state, default_state["header_button"])

	@property
	def section(self):
		self._getter_access_tracker["section"] = {}
		return self._section
	@section.setter
	def section(self, new_state):
		self._setter_access_tracker["section"] = {}
		global default_state
		self._section = Flex(new_state, default_state["section"])

	@property
	def section_detail(self):
		self._getter_access_tracker["section_detail"] = {}
		return self._section_detail
	@section_detail.setter
	def section_detail(self, new_state):
		self._setter_access_tracker["section_detail"] = {}
		global default_state
		self._section_detail = Flex(new_state, default_state["section_detail"])

	@property
	def section_button(self):
		self._getter_access_tracker["section_button"] = {}
		return self._section_button
	@section_button.setter
	def section_button(self, new_state):
		self._setter_access_tracker["section_button"] = {}
		global default_state
		self._section_button = Flex(new_state, default_state["section_button"])

	@property
	def section_img(self):
		self._getter_access_tracker["section_img"] = {}
		return self._section_img
	@section_img.setter
	def section_img(self, new_state):
		self._setter_access_tracker["section_img"] = {}
		global default_state
		self._section_img = Div(new_state, default_state["section_img"])
	...
	@property
	def home_container(self):
		self._getter_access_tracker["home_container"] = {}
		return self._home_container
	@home_container.setter
	def home_container(self, new_state):
		self._setter_access_tracker["home_container"] = {}
		global default_state
		self._home_container = Flex(new_state, default_state["home_container"])

	@property
	def home_content(self):
		self._getter_access_tracker["home_content"] = {}
		return self._home_content
	@home_content.setter
	def home_content(self, new_state):
		self._setter_access_tracker["home_content"] = {}
		global default_state
		self._home_content = Flex(new_state, default_state["home_content"])

	@property
	def home_button(self):
		self._getter_access_tracker["home_button"] = {}
		return self._home_button
	@home_button.setter
	def home_button(self, new_state):
		self._setter_access_tracker["home_button"] = {}
		global default_state
		self._home_button = Flex(new_state, default_state["home_button"])

	@property
	def home_img(self):
		self._getter_access_tracker["home_img"] = {}
		return self._home_img
	@home_img.setter
	def home_img(self, new_state):
		self._setter_access_tracker["home_img"] = {}
		global default_state
		self._home_img = Div(new_state, default_state["home_img"])
	...
	def About(self, new_state):
		...
		global default_state
		self._About = Flex(new_state, default_state["About"])

	@property
	def about_img(self):
		self._getter_access_tracker["about_img"] = {}
		return self._about_img
	@about_img.setter
	def about_img(self, new_state):
		self._setter_access_tracker["about_img"] = {}
		global default_state
		self._about_img = Flex(new_state, default_state["about_img"])

	@property
	def about_img_container(self):
		self._getter_access_tracker["about_img_container"] = {}
		return self._about_img_container
	@about_img_container.setter
	def about_img_container(self, new_state):
		self._setter_access_tracker["about_img_container"] = {}
		global default_state
		self._about_img_container = Div(new_state, default_state["about_img_container"])

	@property
	def about_detail_container(self):
		self._getter_access_tracker["about_detail_container"] = {}
		return self._about_detail_container
	@about_detail_container.setter
	def about_detail_container(self, new_state):
		self._setter_access_tracker["about_detail_container"] = {}
		global default_state
		self._about_detail_container = Flex(new_state, default_state["about_detail_container"])

	@property
	def about_detail_container_1(self):
		self._getter_access_tracker["about_detail_container_1"] = {}
		return self._about_detail_container_1
	@about_detail_container_1.setter
	def about_detail_container_1(self, new_state):
		self._setter_access_tracker["about_detail_container_1"] = {}
		global default_state
		self._about_detail_container_1 = Flex(new_state, default_state["about_detail_container_1"])

	@property
	def about_detail_container_2(self):
		self._getter_access_tracker["about_detail_container_2"] = {}
		return self._about_detail_container_2
	@about_detail_container_2.setter
	def about_detail_container_2(self, new_state):
		self._setter_access_tracker["about_detail_container_2"] = {}
		global default_state
		self._about_detail_container_2 = Flex(new_state, default_state["about_detail_container_2"])

	@property
	def about_detail_container_3(self):
		self._getter_access_tracker["about_detail_container_3"] = {}
		return self._about_detail_container_3
	@about_detail_container_3.setter
	def about_detail_container_3(self, new_state):
		self._setter_access_tracker["about_detail_container_3"] = {}
		global default_state
		self._about_detail_container_3 = Flex(new_state, default_state["about_detail_container_3"])

	@property
	def about_container(self):
		self._getter_access_tracker["about_container"] = {}
		return self._about_container
	@about_container.setter
	def about_container(self, new_state):
		self._setter_access_tracker["about_container"] = {}
		global default_state
		self._about_container = Flex(new_state, default_state["about_container"])

	@property
	def about_button(self):
		self._getter_access_tracker["about_button"] = {}
		return self._about_button
	@about_button.setter
	def about_button(self, new_state):
		self._setter_access_tracker["about_button"] = {}
		global default_state
		self._about_button = Flex(new_state, default_state["about_button"])

	@property
	def instagram(self):
		self._getter_access_tracker["instagram"] = {}
		return self._instagram
	@instagram.setter
	def instagram(self, new_state):
		self._setter_access_tracker["instagram"] = {}
		global default_state
		self._instagram = Flex(new_state, default_state["instagram"])

	@property
	def instagram_head(self):
		self._getter_access_tracker["instagram_head"] = {}
		return self._instagram_head
	@instagram_head.setter
	def instagram_head(self, new_state):
		self._setter_access_tracker["instagram_head"] = {}
		global default_state
		self._instagram_head = Flex(new_state, default_state["instagram_head"])

	@property
	def instagram_content(self):
		self._getter_access_tracker["instagram_content"] = {}
		return self._instagram_content
	@instagram_content.setter
	def instagram_content(self, new_state):
		self._setter_access_tracker["instagram_content"] = {}
		global default_state
		self._instagram_content = Flex(new_state, default_state["instagram_content"])

	@property
	def instagram_container(self):
		self._getter_access_tracker["instagram_container"] = {}
		return self._instagram_container
	@instagram_container.setter
	def instagram_container(self, new_state):
		self._setter_access_tracker["instagram_container"] = {}
		global default_state
		self._instagram_container = Flex(new_state, default_state["instagram_container"])

	@property
	def instagram_container_1(self):
		self._getter_access_tracker["instagram_container_1"] = {}
		return self._instagram_container_1
	@instagram_container_1.setter
	def instagram_container_1(self, new_state):
		self._setter_access_tracker["instagram_container_1"] = {}
		global default_state
		self._instagram_container_1 = Flex(new_state, default_state["instagram_container_1"])

	@property
	def instagram_container_2(self):
		self._getter_access_tracker["instagram_container_2"] = {}
		return self._instagram_container_2
	@instagram_container_2.setter
	def instagram_container_2(self, new_state):
		self._setter_access_tracker["instagram_container_2"] = {}
		global default_state
		self._instagram_container_2 = Flex(new_state, default_state["instagram_container_2"])

	@property
	def category(self):
		self._getter_access_tracker["category"] = {}
		return self._category
	@category.setter
	def category(self, new_state):
		self._setter_access_tracker["category"] = {}
		global default_state
		self._category = Flex(new_state, default_state["category"])

	@property
	def category_content(self):
		self._getter_access_tracker["category_content"] = {}
		return self._category_content
	@category_content.setter
	def category_content(self, new_state):
		self._setter_access_tracker["category_content"] = {}
		global default_state
		self._category_content = Flex(new_state, default_state["category_content"])
	...
	def category_button(self):
		self._getter_access_tracker["category_button"] = {}
		return self._category_button
	@category_button.setter
	def category_button(self, new_state):
		self._setter_access_tracker["category_button"] = {}
		global default_state
		self._category_button = Flex(new_state, default_state["category_button"])
	...
	def footer_details(self):
		self._getter_access_tracker["footer_details"] = {}
		return self._footer_details
	@footer_details.setter
	def footer_details(self, new_state):
		self._setter_access_tracker["footer_details"] = {}
		global default_state
		self._footer_details = Flex(new_state, default_state["footer_details"])

	@property
	def footer_stars(self):
		self._getter_access_tracker["footer_stars"] = {}
		return self._footer_stars
	@footer_stars.setter
	def footer_stars(self, new_state):
		self._setter_access_tracker["footer_stars"] = {}
		global default_state
		self._footer_stars = Flex(new_state, default_state["footer_stars"])

	@property
	def footer_list(self):
		self._getter_access_tracker["footer_list"] = {}
		return self._footer_list
	@footer_list.setter
	def footer_list(self, new_state):
		self._setter_access_tracker["footer_list"] = {}
		global default_state
		self._footer_list = Flex(new_state, default_state["footer_list"])

	@property
	def footer_list_2(self):
		self._getter_access_tracker["footer_list_2"] = {}
		return self._footer_list_2
	@footer_list_2.setter
	def footer_list_2(self, new_state):
		self._setter_access_tracker["footer_list_2"] = {}
		global default_state
		self._footer_list_2 = Flex(new_state, default_state["footer_list_2"])

	@property
	def footer_list_1(self):
		self._getter_access_tracker["footer_list_1"] = {}
		return self._footer_list_1
	@footer_list_1.setter
	def footer_list_1(self, new_state):
		self._setter_access_tracker["footer_list_1"] = {}
		global default_state
		self._footer_list_1 = Flex(new_state, default_state["footer_list_1"])

	@property
	def footer_img(self):
		self._getter_access_tracker["footer_img"] = {}
		return self._footer_img
	@footer_img.setter
	def footer_img(self, new_state):
		self._setter_access_tracker["footer_img"] = {}
		global default_state
		self._footer_img = Flex(new_state, default_state["footer_img"])

	@property
	def footer_img_1(self):
		self._getter_access_tracker["footer_img_1"] = {}
		return self._footer_img_1
	@footer_img_1.setter
	def footer_img_1(self, new_state):
		self._setter_access_tracker["footer_img_1"] = {}
		global default_state
		self._footer_img_1 = Flex(new_state, default_state["footer_img_1"])

	@property
	def footer_img_2(self):
		self._getter_access_tracker["footer_img_2"] = {}
		return self._footer_img_2
	@footer_img_2.setter
	def footer_img_2(self, new_state):
		self._setter_access_tracker["footer_img_2"] = {}
		global default_state
		self._footer_img_2 = Flex(new_state, default_state["footer_img_2"])

	@property
	def Sponsor(self):
		self._getter_access_tracker["Sponsor"] = {}
		return self._Sponsor
	@Sponsor.setter
	def Sponsor(self, new_state):
		self._setter_access_tracker["Sponsor"] = {}
		global default_state
		self._Sponsor = Flex(new_state, default_state["Sponsor"])

	@property
	def sponsor_img(self):
		self._getter_access_tracker["sponsor_img"] = {}
		return self._sponsor_img
	@sponsor_img.setter
	def sponsor_img(self, new_state):
		self._setter_access_tracker["sponsor_img"] = {}
		global default_state
		self._sponsor_img = Flex(new_state, default_state["sponsor_img"])
	...
	def menu_container(self):
		self._getter_access_tracker["menu_container"] = {}
		return self._menu_container
	@menu_container.setter
	def menu_container(self, new_state):
		self._setter_access_tracker["menu_container"] = {}
		global default_state
		self._menu_container = Flex(new_state, default_state["menu_container"])

	@property
	def menu_container_1(self):
		self._getter_access_tracker["menu_container_1"] = {}
		return self._menu_container_1
	@menu_container_1.setter
	def menu_container_1(self, new_state):
		self._setter_access_tracker["menu_container_1"] = {}
		global default_state
		self._menu_container_1 = Flex(new_state, default_state["menu_container_1"])

	@property
	def product_cart_1(self):
		self._getter_access_tracker["product_cart_1"] = {}
		return self._product_cart_1
	@product_cart_1.setter
	def product_cart_1(self, new_state):
		self._setter_access_tracker["product_cart_1"] = {}
		global default_state
		self._product_cart_1 = Flex(new_state, default_state["product_cart_1"])
	...
	@property
	def product_cart_2(self):
		self._getter_access_tracker["product_cart_2"] = {}
		return self._product_cart_2
	@product_cart_2.setter
	def product_cart_2(self, new_state):
		self._setter_access_tracker["product_cart_2"] = {}
		global default_state
		self._product_cart_2 = Flex(new_state, default_state["product_cart_2"])
	...
	@property
	def product_cart_3(self):
		self._getter_access_tracker["product_cart_3"] = {}
		return self._product_cart_3
	@product_cart_3.setter
	def product_cart_3(self, new_state):
		self._setter_access_tracker["product_cart_3"] = {}
		global default_state
		self._product_cart_3 = Flex(new_state, default_state["product_cart_3"])
	...
	@property
	def product_cart_4(self):
		self._getter_access_tracker["product_cart_4"] = {}
		return self._product_cart_4
	@product_cart_4.setter
	def product_cart_4(self, new_state):
		self._setter_access_tracker["product_cart_4"] = {}
		global default_state
		self._product_cart_4 = Flex(new_state, default_state["product_cart_4"])
	...
	@property
	def menu_container_2(self):
		self._getter_access_tracker["menu_container_2"] = {}
		return self._menu_container_2
	@menu_container_2.setter
	def menu_container_2(self, new_state):
		self._setter_access_tracker["menu_container_2"] = {}
		global default_state
		self._menu_container_2 = Flex(new_state, default_state["menu_container_2"])

	@property
	def product_cart_5(self):
		self._getter_access_tracker["product_cart_5"] = {}
		return self._product_cart_5
	@product_cart_5.setter
	def product_cart_5(self, new_state):
		self._setter_access_tracker["product_cart_5"] = {}
		global default_state
		self._product_cart_5 = Flex(new_state, default_state["product_cart_5"])
	...
	@property
	def product_cart_6(self):
		self._getter_access_tracker["product_cart_6"] = {}
		return self._product_cart_6
	@product_cart_6.setter
	def product_cart_6(self, new_state):
		self._setter_access_tracker["product_cart_6"] = {}
		global default_state
		self._product_cart_6 = Flex(new_state, default_state["product_cart_6"])
	...
	@property
	def product_cart_7(self):
		self._getter_access_tracker["product_cart_7"] = {}
		return self._product_cart_7
	@product_cart_7.setter
	def product_cart_7(self, new_state):
		self._setter_access_tracker["product_cart_7"] = {}
		global default_state
		self._product_cart_7 = Flex(new_state, default_state["product_cart_7"])
	...
	@property
	def product_cart_8(self):
		self._getter_access_tracker["product_cart_8"] = {}
		return self._product_cart_8
	@product_cart_8.setter
	def product_cart_8(self, new_state):
		self._setter_access_tracker["product_cart_8"] = {}
		global default_state
		self._product_cart_8 = Flex(new_state, default_state["product_cart_8"])
	...
	def menu_button(self):
		self._getter_access_tracker["menu_button"] = {}
		return self._menu_button
	@menu_button.setter
	def menu_button(self, new_state):
		self._setter_access_tracker["menu_button"] = {}
		global default_state
		self._menu_button = Flex(new_state, default_state["menu_button"])
	...
	def review_button(self):
		self._getter_access_tracker["review_button"] = {}
		return self._review_button
	@review_button.setter
	def review_button(self, new_state):
		self._setter_access_tracker["review_button"] = {}
		global default_state
		self._review_button = Flex(new_state, default_state["review_button"])

	@property
	def review_detail(self):
		self._getter_access_tracker["review_detail"] = {}
		return self._review_detail
	@review_detail.setter
	def review_detail(self, new_state):
		self._setter_access_tracker["review_detail"] = {}
		global default_state
		self._review_detail = Flex(new_state, default_state["review_detail"])

	@property
	def review_arrow_1(self):
		self._getter_access_tracker["review_arrow_1"] = {}
		return self._review_arrow_1
	@review_arrow_1.setter
	def review_arrow_1(self, new_state):
		self._setter_access_tracker["review_arrow_1"] = {}
		global default_state
		self._review_arrow_1 = Flex(new_state, default_state["review_arrow_1"])

	@property
	def review_content(self):
		self._getter_access_tracker["review_content"] = {}
		return self._review_content
	@review_content.setter
	def review_content(self, new_state):
		self._setter_access_tracker["review_content"] = {}
		global default_state
		self._review_content = Flex(new_state, default_state["review_content"])

	@property
	def review_stars(self):
		self._getter_access_tracker["review_stars"] = {}
		return self._review_stars
	@review_stars.setter
	def review_stars(self, new_state):
		self._setter_access_tracker["review_stars"] = {}
		global default_state
		self._review_stars = Flex(new_state, default_state["review_stars"])

	@property
	def review_img(self):
		self._getter_access_tracker["review_img"] = {}
		return self._review_img
	@review_img.setter
	def review_img(self, new_state):
		self._setter_access_tracker["review_img"] = {}
		global default_state
		self._review_img = Flex(new_state, default_state["review_img"])

	@property
	def review_img_detail(self):
		self._getter_access_tracker["review_img_detail"] = {}
		return self._review_img_detail
	@review_img_detail.setter
	def review_img_detail(self, new_state):
		self._setter_access_tracker["review_img_detail"] = {}
		global default_state
		self._review_img_detail = Flex(new_state, default_state["review_img_detail"])

	@property
	def review_arrow_2(self):
		self._getter_access_tracker["review_arrow_2"] = {}
		return self._review_arrow_2
	@review_arrow_2.setter
	def review_arrow_2(self, new_state):
		self._setter_access_tracker["review_arrow_2"] = {}
		global default_state
		self._review_arrow_2 = Flex(new_state, default_state["review_arrow_2"])
	...
	def _to_json_fields(self):
		return {
			"header": self._header,
			"header_detail": self._header_detail,
			"header_logo": self._header_logo,
			"header_menu": self._header_menu,
			"header_button": self._header_button,
			"section": self._section,
			"section_detail": self._section_detail,
			"section_button": self._section_button,
			"section_img": self._section_img,
			"home": self._home,
			"home_container": self._home_container,
			"home_content": self._home_content,
			"home_button": self._home_button,
			"home_img": self._home_img,
			"About": self._About,
			"about_img": self._about_img,
			"about_img_container": self._about_img_container,
			"about_detail_container": self._about_detail_container,
			"about_detail_container_1": self._about_detail_container_1,
			"about_detail_container_2": self._about_detail_container_2,
			"about_detail_container_3": self._about_detail_container_3,
			"about_container": self._about_container,
			"about_button": self._about_button,
			"instagram": self._instagram,
			"instagram_head": self._instagram_head,
			"instagram_content": self._instagram_content,
			"instagram_container": self._instagram_container,
			"instagram_container_1": self._instagram_container_1,
			"instagram_container_2": self._instagram_container_2,
			"category": self._category,
			"category_content": self._category_content,
			"Flex30": self._Flex30,
			"Flex31": self._Flex31,
			"Flex32": self._Flex32,
			"Flex33": self._Flex33,
			"category_button": self._category_button,
			"footer": self._footer,
			"footer_details": self._footer_details,
			"footer_stars": self._footer_stars,
			"footer_list": self._footer_list,
			"footer_list_2": self._footer_list_2,
			"footer_list_1": self._footer_list_1,
			"footer_img": self._footer_img,
			"footer_img_1": self._footer_img_1,
			"footer_img_2": self._footer_img_2,
			"Sponsor": self._Sponsor,
			"sponsor_img": self._sponsor_img,
			"menu": self._menu,
			"menu_container": self._menu_container,
			"menu_container_1": self._menu_container_1,
			"product_cart_1": self._product_cart_1,
			"Div6": self._Div6,
			"product_cart_2": self._product_cart_2,
			"Div7": self._Div7,
			"product_cart_3": self._product_cart_3,
			"Div8": self._Div8,
			"product_cart_4": self._product_cart_4,
			"Div9": self._Div9,
			"menu_container_2": self._menu_container_2,
			"product_cart_5": self._product_cart_5,
			"Div10": self._Div10,
			"product_cart_6": self._product_cart_6,
			"Div11": self._Div11,
			"product_cart_7": self._product_cart_7,
			"Div12": self._Div12,
			"product_cart_8": self._product_cart_8,
			"Div13": self._Div13,
			"menu_button": self._menu_button,
			"review": self._review,
			"review_button": self._review_button,
			"review_detail": self._review_detail,
			"review_arrow_1": self._review_arrow_1,
			"review_content": self._review_content,
			"review_stars": self._review_stars,
			"review_img": self._review_img,
			"review_img_detail": self._review_img_detail,
			"review_arrow_2": self._review_arrow_2,
